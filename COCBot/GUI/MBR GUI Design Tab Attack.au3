...
$tabAttack = GUICtrlCreateTabItem(GetTranslated(3,1, "Attack"))
	...
	$grpDeadBaseDeploy = GUICtrlCreateGroup(GetTranslated(3,2, "DeadBase Deploy"), $x - 20, $y - 20, 225, 300);95)
		...
		$cmbDBDeploy = GUICtrlCreateCombo("", $x + 55, $y, 120, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetData(-1, GetTranslated(3,8, "one side") & "|" & GetTranslated(3,9, "two sides") & "|" & GetTranslated(3,10, "three sides") &"|" & GetTranslated(3,11,"all sides equally" ) &"|" & GetTranslated(3,103,"Four Fingers" ) &"|" & GetTranslated(3,104,"Smart Save Troop" ), GetTranslated(3,11, "all sides equally"))
			GUICtrlSetOnEvent(-1, "cmbDBDeploy")
		$y += 25
