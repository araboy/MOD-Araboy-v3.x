...
$tabNotify = GUICtrlCreateTabItem(GetTranslated(9,1, "Notify"))
	...
	$picPushBullet = GUICtrlCreateIcon ($pIconLib, $eIcnPushBullet, $x, $y, 64, 32)
	...
	$cmbHoursPushBullet = GUICtrlCreateCombo("", $x + 300, $y, 100, 35, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
		...
		GUICtrlSetState (-1, $GUI_DISABLE)
	$y += 30
	$lblPushBTokenValue = GUICtrlCreateLabel(GetTranslated(9,16, "PushBullet Token") & ":", $x, $y, -1, -1, $SS_RIGHT)
    ...
    $lblPushBTokenValue2 = GUICtrlCreateLabel(GetTranslated(9,54,"Telegram Token"), $x, $y+23, -1, -1, $SS_RIGHT)
